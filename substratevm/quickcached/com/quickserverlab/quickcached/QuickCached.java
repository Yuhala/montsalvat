...
public class QuickCached {
    ...
    public static final String homeBase = "/home/petman/projects/benchmarks-graal/quickcached/";
    ...
    public static void main(String args[]) throws Exception {
        ...
        /* if (args.length != 0) {
            while (i < args.length) {
                ...
                if (arg.equals("-v") || arg.equals("-vv")) {
                    ...
                    DOMConfigurator.configure(homeBase + "conf/log4j_debug.xml");
                } else {
                    DOMConfigurator.configure(homeBase + "conf/log4j.xml");
                }
        ...
        String confFile = homeBase + "conf" + File.separator + "QuickCached.xml";
        Object config[] = new Object[] { confFile };

        quickcached = new QuickServer();
        quickcached.initService(config);
        System.out.println("After init service");
        ...
        // This is an important option to consider as there is no other way to secure
        // the installation.
 ...
 */
        try {
            if (quickcached != null) {
                ...
                System.out.println("Started quickcached server");
                //printMemoryInfo();
            }
    ...
    public static void printHelp() {
        ...
        System.out.println(
                "-v            verbose (print errors/warnings while in event loop). Creates logs in log folder");
