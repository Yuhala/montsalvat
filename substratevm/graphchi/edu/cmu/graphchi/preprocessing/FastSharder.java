...
public class FastSharder <VertexValueType, EdgeValueType> {
     ...
     * @throws IOException
     */
    public void shardGraph(InputStream inputStream, GraphInputFormat format) throws IOException {
    ...
    public void shard(InputStream inputStream, String format) throws IOException {
        if (format == null || format.equals("edgelist")) {
            shardGraph(inputStream, GraphInputFormat.EDGELIST);
        }
        else if (format.equals("adjlist") || format.startsWith("adjacency")) {
            shardGraph(inputStream, GraphInputFormat.ADJACENCY);
        }
    }
     ...
     * @throws IOException
     */
    //commented for now: issues with duplicate names: pyuhala: fix me!
