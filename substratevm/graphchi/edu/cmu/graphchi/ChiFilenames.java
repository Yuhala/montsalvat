...
public class ChiFilenames {
    ...
    public static String getFilenameShardEdata(String baseFilename, BytesToValueConverter valueConv, int p,
            int nShards) {
    ...
    public static int getPid() {
        try {
            ...
            /*
             * java.lang.management.VMManagement mgmt = (sun.management.VMManagement)
             * jvm.get(runtime); java.lang.reflect.Method pid_method =
             * mgmt.getClass().getDeclaredMethod("getProcessId");
             * pid_method.setAccessible(true); return (Integer) pid_method.invoke(mgmt);
             */
            // TODO
            return 0;
        } catch (Exception err) {
    ...
    public static ArrayList<VertexInterval> loadIntervals(String baseFilename, int nShards)
        ...
        System.out.println("Returning intervals");
        return intervals;
    }
