package pers.graph_generator;

import java.util.ArrayList;
import java.util.Random;

/**
 * Graph generator based on the R-MAT algorithm R-MAT: A Recursive Model for
 * Graph Mining Chakrabarti, Zhan, Faloutsos:
...
public class RMATGraphGenerator {
    ...
    /**
     * From http://pywebgraph.sourceforge.net ## Probability of choosing quadrant A
     * self.probA = 0.45
     * 
     * ## Probability of choosing quadrant B self.probB = 0.15
     * 
     * ## Probability of choosing quadrant C self.probC = 0.15
     * 
     * ## Probability of choosing quadrant D self.probD = 0.25
     */

    public RMATGraphGenerator(GraphOutput outputter, double pA, double pB, double pC, double pD, int nVertices,
            long nEdges) {
    ...
    public static void main(String[] args) {
        ...
        //pyuhala: using example probabilities
        double pA = 0.45;
        double pB = 0.15;
        double pC = 0.15;
        double pD = 0.25;
