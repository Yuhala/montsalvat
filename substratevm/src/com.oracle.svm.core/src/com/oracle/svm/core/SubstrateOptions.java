...
public class SubstrateOptions {
    ...
    @APIOption(name = "sgx-in")//
    @Option(help = "Build secure sgx object")//
    public static final HostedOptionKey<Boolean> SgxIn = new HostedOptionKey<>(false);

    @APIOption(name = "sgx-out")//
    @Option(help = "Build unsecure sgx object")//
    public static final HostedOptionKey<Boolean> SgxOut = new HostedOptionKey<>(false);
