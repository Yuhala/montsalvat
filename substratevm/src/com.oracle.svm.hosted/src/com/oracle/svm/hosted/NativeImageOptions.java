...
public class NativeImageOptions {
    ...
    @Option(help = "Object destined for SGX module and can exit after writing relocatable object")//
    public static final HostedOptionKey<Boolean> IsSGXObject = new HostedOptionKey<>(true);
