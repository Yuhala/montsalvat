...
public final class GCImpl implements GC {
    ...
    private void printGCBefore(String cause) {
        ...
        if ((SubstrateGCOptions.VerboseGC.getValue() && getCollectionEpoch().equal(1)) || true) {
        ...
        if (SubstrateGCOptions.VerboseGC.getValue() || true) {
            verboseGCLog.string("[");
            verboseGCLog.string("[");
    ...
    private void printGCAfter(String cause) {
        Log verboseGCLog = Log.log();
        HeapImpl heap = HeapImpl.getHeapImpl();
        if (SubstrateGCOptions.PrintGC.getValue() || SubstrateGCOptions.VerboseGC.getValue() || true) {
            if (SubstrateGCOptions.PrintGC.getValue() || true) {
