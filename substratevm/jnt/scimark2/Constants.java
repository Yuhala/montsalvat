...
public class Constants {
	...
	// extra large (out-of-cache) problem sizes
	public static final int XLG_FFT_SIZE = 4194304 * 32; // must be a power of two
	public static final int XLG_SOR_SIZE = 2048 * 16; // NxN grid
	public static final int XLG_SPARSE_SIZE_M = 200000 * 80;
	public static final int XLG_SPARSE_SIZE_nz = 1000000;
	public static final int XLG_LU_SIZE = 2048 * 16;
