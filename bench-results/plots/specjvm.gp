...
set title "{/: Specjvm micro-benchmarks}" font ",13" offset 0.5,-0.5
set ylabel "Execution time (ms)" font "Helvetica,15" offset 2.8,0
set xlabel "Micro-bench" font "Helvetica,15" offset 2.0,0
...
plot 'data/specjvm.csv' using 2:xtic(1) ti col, '' u 3:xtic(1) ti col



!epstopdf "specjvm.eps"
!rm "specjvm.eps"
quit 